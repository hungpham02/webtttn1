...
$sql = "SELECT YEAR(ngaydat) AS nam, MONTH(ngaydat) AS thang, SUM(soluongban) AS soluongban FROM tbl_thongke GROUP BY YEAR(ngaydat), MONTH(ngaydat)";
$result = mysqli_query($connect, $sql);

// Tạo mảng dữ liệu cho biểu đồ
$data = array();
$data[] = ['Tháng', 'Số lượng bán'];
while ($row = mysqli_fetch_assoc($result)) {
    $data[] = [date('M Y', mktime(0, 0, 0, $row['thang'], 1, $row['nam'])), (int)$row['soluongban']];
}
...
<html>
<head>
    <h4 style="text-align: center;">Thống kê số lượng bạn hàng theo tháng</h4>
<div class="">
