...
$sql_show = "SELECT * FROM tbl_sanpham WHERE tbl_sanpham.id_loaisanpham='$_GET[id]' ORDER BY id_sanpham DESC";
$query_show = mysqli_query($connect, $sql_show);

//get ten danh muc
$sql_cate = "SELECT * FROM tbl_loaisanpham WHERE id_loaisanpham='$_GET[id]' LIMIT 1";
...
<h5> Loại sản phẩm |
    <?php
    if (isset($row_title['tenloaisanpham'])) {
        echo $row_title['tenloaisanpham'];
    } else {
